...
// creating a user class with user information
    public function __construct($first_name, $last_name, $date_of_birth, $phone_number, $address, $city, $state, $zip, $email, $username, $password, $user_level, $count_created, $id_user=null){
